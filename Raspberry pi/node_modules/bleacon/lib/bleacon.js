...
Bleacon.prototype.startScanning = function(uuid, major, minor, noDuplicates) {
  ...
  //var duplicates = !noDuplicates; //makes duplicates
  var duplicates = noDuplicates; //no duplicates
...
Bleacon.prototype.onDiscover = function(peripheral) {
  ...
  if (manufacturerData &&
    ...
    if ((!this._uuid || this._uuid.indexOf(uuid) != -1 ) &&
      ...
      var accuracy1 = (0.89976)*Math.pow(((rssi*1.0)/measuredPower),7.7095)+0.111;
     /// var accuracy = 10 * Math.pow((measuredPower-rssi)/20);
      var accuracy2 = Math.sqrt(Math.pow(10,((measuredPower-rssi)/10)));
...
//      bleacon.accuracy1 = accuracy1;
//      bleacon.accuracy2 = accuracy2;
